            ...
            <div className="w-full max-w-2xl mx-auto my-8">
                ...
                >
                    {slides.map((slide) => {
                        ...
                        return (
                            <SwiperSlide key={slide.id} className="rounded-xl">
                                <Card
                                    className="bg-transparent shadow-none border-none"
                                    style={{height: slideHeight}}
                                >
                                    <div
                                        className="w-full h-full bg-white rounded-xl overflow-hidden relative shadow-sm border">
                                        {slide.title && (
                                            <div
                                                className={`absolute top-0 left-0 right-0 border-b px-4 py-3 z-10  ${headerClass}`}
                                            >
