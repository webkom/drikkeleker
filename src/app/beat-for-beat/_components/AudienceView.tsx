        ...
        <main className="overflow-x-hidden">
            ...
            <span className="text-xs uppercase tracking-widest text-amber-900/70">
              Rom
                    ...
                    {!audioArmed && (
                        <div
                            className="w-full max-w-md bg-white/90 rounded-2xl p-4 flex flex-col items-center gap-2 text-center">
                ...
                <span
                    className="rounded-full bg-amber-500 text-white text-sm font-semibold px-3 py-1 uppercase tracking-wide">
                  Verdt {state.round.pointValue} poeng
                </span>
                                <span
                                    className="rounded-full bg-white/80 text-amber-900 text-sm font-semibold px-3 py-1">
