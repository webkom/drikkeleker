            ...
            >
              ...
              >
                <div className="p-4 border-b border-amber-100 flex justify-between items-center bg-amber-50/50">
                  <h2
                    id="help-title"
                    className={`${lilita.className} text-xl text-amber-900`}
                  >
                    Hvordan spille:
                  </h2>
                  ...
                  >
                    <Step>
                      <h3 className="font-bold text-gray-900 mb-1">
                        1. Lag eller bli med i rom
                      </h3>
                      <p className="text-xs text-gray-600 leading-relaxed">
                        En spiller trykker{" "}
                        <strong>&ldquo;Lag rom&rdquo;</strong> og blir host. De
                        får en romkode de deler med de andre spillerne, som blir
                        med ved å skrive koden i{" "}
                        <strong>&ldquo;Bli med&rdquo;</strong>-feltet.
                      </p>
                    </Step>
                    <Step>
                      <h3 className="font-bold text-gray-900 mb-1">
                      ...
                      <p className="text-xs text-gray-600 leading-relaxed">
                        Hosten (admin) velger sanger fra{" "}
                        <strong>Sangsarkivet</strong> eller taster dem inn
                        manuelt. Admin kan også konfigurere poeng, tidsfrist, og
                    ...
                    <Step>
                      ...
                      <p className="text-xs text-gray-600 leading-relaxed">
                        Det aktive laget velger et tall på tavlen. Ordet snus og
                        avsløres for alle spillere og publikum.
                      </p>
                    </Step>
                    <Step>
                      ...
                      <p className="text-xs text-gray-600 leading-relaxed">
                        <strong>Svarte ord:</strong> Timeren starter! Dere må
                        gjette sangen og{" "}
                        <span className="text-amber-800 font-bold">
                          synge strofen
                        </span>{" "}
                        for å score rundepoengene!
                        <br />
                        <strong>Røde ord:</strong> Turen går direkte til det
                        andre laget uten sjanse til å gjette.
                      </p>
                    </Step>
                  </Stepper>
                </div>
