            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <Input
                  ...
                  maxLength={6}
                  className="text-center text-2xl font-mono tracking-widest [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                  style={{
...
export default KahootStyleLobby;
